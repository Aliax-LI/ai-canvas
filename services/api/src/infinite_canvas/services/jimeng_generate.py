"""Jimeng provider image/video generation — legacy parity."""
...
from infinite_canvas.services.jimeng import (
    jimeng_cli_path_arg,
    jimeng_poll_seconds,
...
from infinite_canvas.services.provider_helpers import parse_size_pair
